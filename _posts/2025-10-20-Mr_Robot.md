...
<br>
<br>
![img]({{ '/assets/images/robot/mrrobot.jpeg' | relative_url }}){: .center-image }

<span style="align: center">[Link To CTF](https://tryhackme.com/room/mrrobot)</span>
<br>
<br>
<br>
...
## /login and /wp-login take us to the wordpress login page
...
## Moving to this directory gives us Key #1:
{% highlight bash %}
...
## At the login page enter false credentials and capture the request in Burpsuite
{% highlight bash %}
Enter: 
username: test
password: test 
...
## We now have a valid username and a valid password
![img]({{ '/assets/images/robot/11-robot.png' | relative_url }}){: .center-image }
<br>
...
$ nc -lvnp <port>
then navigate to:
http://target_IP/wp-content/themes/twentyfiftenen/404.php
{% endhighlight bash %}
<br>
...
## We are not allowed to read the key file 
## But we can read the md5 password hash file
